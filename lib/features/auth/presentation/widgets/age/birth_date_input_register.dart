...
// Clase `BirthDateInputRegister` que extiende `ConsumerWidget` para utilizar datos de un proveedor.
class BirthDateInputRegister extends ConsumerWidget {
  // Constructor que crea una instancia de la clase y pasa la clave (un identificador único) al superconstructor.
  const BirthDateInputRegister({super.key});
  ...
  InputBorder _getBorder(BuildContext context, formValues,
    ...
    // La lógica para determinar el borde es idéntica a la clase anterior.
