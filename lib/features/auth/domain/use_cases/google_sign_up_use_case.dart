  ...
  Future<void> execute(
    ...
    try {
      ...
      if (userImage.isEmpty) {
        ...
        await _avatarUploadUseCase.execute(avatarFile);
      } else {
        await _avatarUploadUseCase.execute(File(userImage));
      }
...
GoogleSignUpUseCase googleSignUpUseCase(GoogleSignUpUseCaseRef ref) {
  ...
  return GoogleSignUpUseCase(authRepository, firestoreRepository,
      storeUserUseCase, avatarUpLoadUseCase, googleUserRepository);
}
